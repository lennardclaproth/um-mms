...
class UserDeletePage(Page, metaclass=AutoWire):

    def __init__(self, engine: Engine, app_context: AppContext):
        self._action = engine.registry.get_action(DeleteUserAction)
    ...
    def render_body(self, size):
        text = 'Are you sure you want to delete the user? Press M to go back to the menu. Press any other button to delete the user.'
