...
class MemberUpdateCityPage(Page, metaclass=AutoWire):
    ...
    def render_body(self, size):
        self._app_context.selected_member.city = Input.get_component("Please enter the city, this can be one of the following. \n1. The Hague, \n2. Rotterdam, \n3. Leiden, \n4. Amsterdam \n5. Delft, \n6. Utrecht, \n7. Arnhem, \n8. Haarlem, \n9. Den Bosch, \n10. Zwolle", {
            'height': 15, 'width': 100, 'y': 3, 'x': 1, 'input_y': 11})

    def perform_action(self):
        return self._action.act(input=self._app_context.selected_member, page=self, attribute='city')
