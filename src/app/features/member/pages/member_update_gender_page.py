...
class MemberUpdateGenderPage(Page, metaclass=AutoWire):
    ...
    def render_body(self, size):
        self._app_context.selected_member.gender = Input.get_component("Please enter the gender: \n1 for Male, \n2 for Female, \n3 for Other", {
            'height': 15, 'width': 100, 'y': 3, 'x': 1, 'input_y': 4})

    def perform_action(self):
        return self._action.act(input=self._app_context.selected_member, page=self, attribute='gender')
