...
class MemberUpdateEmailAddress(Page, metaclass=AutoWire):
    ...
    def render_body(self, size):
        self._app_context.selected_member.email_address = Input.get_component("Please enter the email adress", {
            'height': 15, 'width': 100, 'y': 3, 'x': 1, 'input_y': 1})

    def perform_action(self):
        return self._action.act(input=self._app_context.selected_member, page=self, attribute='email_address')
